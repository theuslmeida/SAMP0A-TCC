export default function NavBarProf() {
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <a href="/Professor" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Professor</a>
    ...
    <div class="sm:hidden flex justify-center"  id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 flex">
        ...
        <a href="/Professor" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Professor</a>
