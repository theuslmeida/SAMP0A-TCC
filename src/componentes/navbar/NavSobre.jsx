export default function NavSobreN() {
    class voltar { href="/"}
    return (
      <nav class="bg-white ">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <a href="/Sobre" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Sobre Nós</a>
            </div>
          </div>
        </div>
    ...
    <div class="sm:hidden flex justify-center"  id="mobile-menu">
      ...
      <a href="/" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Aluno</a>
         <a href="/Sobre" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Sobre Nós</a>
      </div>
    </div>
  </nav>
    );
